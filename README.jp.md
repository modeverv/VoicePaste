...
- **Push-to-Talkホットキー** : GUIを最前面に出し、押している間だけ録音する
...
GUI使用時は、起動時にウィンドウを表示します。グローバルホットキーを押すと
GUIを最前面に出して録音を開始し、離すと録音を停止して文字起こしを開始します。
GUIにフォーカスがある状態で `Esc` を押すとウィンドウを非表示にできます。
次にホットキーを押すと、再びGUIを表示して新しい録音を開始します。
